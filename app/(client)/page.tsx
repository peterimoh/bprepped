          ...
          <div className="grid items-center gap-16 md:grid-cols-2">
            ...
            <div className="relative">
              <div className="relative flex aspect-square items-center justify-center overflow-hidden rounded-3xl border border-border/20 bg-gradient-to-br from-primary/10 to-accent/10 shadow-2xl">
                ...
                <Image
                  src={
                    'https://res.cloudinary.com/dywofwzdx/image/upload/v1765092611/pexels-sora-shimazaki-5673488_uj786a.jpg'
                  }
                  alt={'logo'}
                  fill
                  objectFit="cover"
      ...
      <footer className="border-t border-border bg-card py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground">
            &copy; {new Date().getFullYear()} B-Prepped AI. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
